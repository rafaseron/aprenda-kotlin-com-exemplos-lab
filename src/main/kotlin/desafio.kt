...
val android = Formacao("Android Developer", listOf(modulo1, modulo2, modulo3, modulo4))
    ...
    - PRIMEIRO EXEMPLO: UTILIZANDO UMA LISTA MUTAVEL E PASSANDO OS OBJETOS PRO CONSTRUTOR DA
    CLASSE "Formacoes" (forma padrão do projeto)
    - SEGUNDO EXEMPLO: UTILIZANDO UMA LISTA IMUTAVEL PARA PODER ENTÃO ADICIONAR, REMOVER E MANIPULAR
